          ...
          {step === 3 && (
            <form onSubmit={handleConfirmBooking} className="space-y-5 animate-in fade-in duration-150">
              ...
              <div className="space-y-3 pt-2">
                ...
                {/* Simulated NMI TLS Card Details if Credit Card */}
                {paymentMethod === 'credit_card' && (
                  <div className="p-4 bg-slate-50 border border-slate-200 rounded-2xl space-y-2.5 animate-in fade-in duration-150">
                    <div className="flex items-center justify-between text-xs pb-1.5 border-b border-slate-200">
                      <span className="font-extrabold text-slate-900">Encrypted Card Details</span>
                ...
                >
                  {isSubmitting ? (
                    ...
                    <>
                      ...
                      <span>
                        {paymentMethod === 'credit_card'
                          ? `Pay $${totalPrice.toFixed(2)} & Confirm Appointment`
