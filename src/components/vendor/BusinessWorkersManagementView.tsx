  ...
  return (
    <div className="space-y-6 pb-16 animate-in fade-in max-w-7xl mx-auto">
      ...
      <div className="bg-white rounded-3xl p-6 sm:p-7 border border-slate-200/90 shadow-2xs flex flex-col md:flex-row md:items-center justify-between gap-4">
        ...
        {/* View Switcher Tabs */}
        <div className="flex items-center bg-slate-100 p-1 rounded-2xl self-start md:self-auto border border-slate-200">
          <button
            type="button"
          ...
          <div className="space-y-3">
            ...
            {availableWorkers.length === 0 ? (
              <div className="p-12 bg-white rounded-3xl border border-slate-200 text-center space-y-2">
                ...
                <p className="text-xs font-bold text-slate-700">No worker accounts found</p>
                <p className="text-[11px] text-slate-400">
                  Workers can register and accept agreements at /worker/onboarding.
                </p>
              </div>
            ) : (
      ...
      {activeTab === 'roster' && (
        <div className="bg-white rounded-3xl p-6 border border-slate-200/90 shadow-2xs space-y-5">
          <div>
            ...
            <p className="text-xs text-slate-500 font-medium">
              Specialists authorized to provide services for {businessName}.
            </p>
          </div>
