      ...
      <div className="bg-white rounded-2xl sm:rounded-3xl border border-slate-200/80 shadow-2xs p-6 sm:p-7 flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div className="space-y-1.5">
          ...
          <p className="text-xs text-slate-500 leading-relaxed max-w-2xl">
            Complete all 5 regulatory sub-checks below to enable submission for Super-Admin review. Required for payout activation and marketplace listing.
          </p>
        </div>
      </div>

      {/* 5 Regulatory Sections */}
