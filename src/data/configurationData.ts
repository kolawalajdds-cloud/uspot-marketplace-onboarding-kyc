...
export const INITIAL_NMI_ADMIN_CONFIGS: AdminConfigRecord[] = [
  ...
  },
  {
    ...
    key: 'api_url',
    isSecret: false,
    valuePlain: 'https://sandbox.nmi.com/api/transact.php',
  ...
  },
  {
    ...
    isSecret: false,
    valuePlain: 'sandbox',
    description: 'Gateway mode (sandbox or production)',
    environment: 'sandbox',
    updatedBy: 'usr-admin-super',
    createdAt: '2026-08-15T10:00:00Z',
    updatedAt: '2026-09-10T16:25:00Z',
...
export const INITIAL_TWILIO_ADMIN_CONFIGS: AdminConfigRecord[] = [
  {
    ...
    key: 'account_sid',
    isSecret: false,
    valuePlain: 'AC_MOCK_TWILIO_ACCOUNT_SID_SANDBOX',
  ...
  },
  {
    ...
    isSecret: false,
    valuePlain: 'false',
    description: 'Mock/Development Mode (log SMS messages to console without carrier dispatch)',
    environment: 'sandbox',
    updatedBy: 'usr-admin-super',
    createdAt: '2026-08-15T10:00:00Z',
...
export const INITIAL_MIDDESK_ADMIN_CONFIGS: AdminConfigRecord[] = [
  ...
  },
  {
    ...
    key: 'base_url',
    isSecret: false,
    valuePlain: 'https://api-sandbox.middesk.com/v1',
